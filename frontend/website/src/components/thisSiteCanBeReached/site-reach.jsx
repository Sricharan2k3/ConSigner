...
export default function ThisCantBeReached() {
  ...
  return (
    <motion.div
      ...
      className="absolute h-screen w-full bg-gray-900 py-16 sm:py-40 px-4 sm:px-24 md:px-36 lg:px-48 xl:px-96 flex flex-col space-y-5 sm:space-y-10"
    >
      <div className="relative w-full flex flex-col space-y-4">
        ...
        <motion.div
          ...
          <div className="absolute h-1 w-1/2 bg-gray-300"></div>
          <div className="absolute h-full w-1 bg-gray-300"></div>
          <div className="absolute bottom-0 h-1 w-full bg-gray-300"></div>
          <div className="absolute right-0 bottom-0 h-6 w-1 bg-gray-300"></div>
          ...
          >
            <div className="absolute right-3 top-0 h-1 w-1 bg-gray-300"></div>
        ...
        <motion.span
          ...
          className="absolute font-bold text-gray-300 text-2xl">
          Hello!
        </motion.span>
        ...
        >
          <span className="text-gray-300 font-Header text-2xl">
            This site{" "}
            {ShowText ? (
              <motion.span
          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex flex-col space-y-2 pl-10">
              <span className="text-Header text-gray-400 font-Header sm:text-base text-sm">
                <span className="text-bold text-gray-300">&bull;</span> Checking
                the connection
              </span>
              <span className="text-Header text-blue-300 font-Header sm:text-base text-sm">
                <span className="text-bold text-gray-300">&bull;</span> Checking
                the proxy and the firewall
              </span>
              <span className="text-Header text-blue-300 font-Header sm:text-bdase text-sm">
                <span className="text-bold text-gray-300">&bull;</span> Running
      ...
      <motion.div
        ...
        className=""
      >
        <button className="px-4 py-2 bg-blue-300 rounded text-white sm:text-base text-sm">
